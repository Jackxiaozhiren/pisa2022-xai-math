...
- Integrates Bronfenbrenner's ecological systems theory and van Dijk's digital divide framework to organize ICT predictors by access, skills/confidence, usage, and outcomes dimensions within a predictive modeling workflow.
- Uses PISA 2022 public-use data from 613,744 students in 80 countries/economies with full survey-weight integration and systematic hyperparameter tuning via Bayesian optimization.
- Tuned XGBoost achieved strongest overall weighted holdout performance: regression RMSE = 54.10, R² = 0.681; classification AUC = 0.903, Brier = 0.126 — a 23% improvement over linear baselines.
